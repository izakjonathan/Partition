...
export default function Privacy() {
  ...
  return <main className="narrow prose"><a href="/">← Event page</a><h1>Privacy information</h1>
    ...
    <h2>Storage and access</h2><p>Responses are stored in a Neon PostgreSQL database, served through Vercel, and accessible only to the authorised organiser in a separate administration deployment with an administrator login. Resend delivers confirmation emails. These providers may use subprocessors and international transfers as described in their agreements. We do not sell your information.</p>
